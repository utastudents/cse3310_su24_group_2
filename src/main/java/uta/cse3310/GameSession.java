...
            boolean revealed = currentPuzzle.revealLetter(vowel);
            if (revealed) {
                System.out.println("Vowel " + vowel + " revealed");
            } else {
                System.out.println("Vowel " + vowel + " not present in the puzzle");
            }
            nextTurn();
        } else {
            System.out.println("Cannot buy vowel: Either not player's turn or insufficient score");
        }
    }
